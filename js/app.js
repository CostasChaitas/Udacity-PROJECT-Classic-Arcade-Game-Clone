...
var Enemy = function() {
    this.sprite = 'images/enemy-bug-'+random(1,6)+'.png';
    this.xRange = [-150, 800];
   ...
   /**
    ...
    for (var enemy = 0; enemy < length; enemy ++) {
        ...
        if (Math.abs(allEnemies[enemy].x - this.x) < 50 &&
            ...
            /**
             * Check the player's gender, play correct voice, remove a life,
             *     and reset location if collision happens.
             */
            if (this.type === 1) {
                sounds[1].play();
            }
...
var carl = new Enemy();
var anna = new Enemy();
var allEnemies = [ada, bob, carl,anna];
