...
/**
 * Puts all audio to be used in app.js into an array.
 */
var sounds = [
...
(function() {
     ...
     *     image. It will then call our private image loading function
     *     accordingly.
     *  {array|string} urlOrArr An array of strings pointing to image
     *     files or a string for a single image.
     */
    function load(urlOrArr) {
        if(urlOrArr instanceof Array) {
             ...
             *     and call our imageloader on that image file
             */
     ...
     *  {string} url A URL for an image.
     * return An image if it is cached.
     */
    function _load(url) {
     ...
     * return {boolean} Images loaded or not.
     */
    function isReady() {
        var ready = true;
